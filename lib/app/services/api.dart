...
//return an API object using the developmentApiKey key
  ...
  Uri getSummonerDataByNameUri(summonersName) => Uri(
        ...
        host: host,
        path:
            'lol/summoner/v4/summoners/by-name/${summonersName != null ? summonersName : name}',
      );
  ...
  Uri getSummonerLeagueDataByName(summonerId) => Uri(
        ...
        host: host,
        path:
            'lol/league/v4/entries/by-summoner/${summonerId != null ? summonerId : null}',
      );
  ...
  Uri getMatchDataByAccountUri(accountId) => Uri(
        ...
        host: host,
        path:
            'lol/match/v4/matchlists/by-account/${accountId != null ? accountId : null}',
      );
}
