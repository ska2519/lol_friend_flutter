      ...
      appBar: AppBar(
        ...
        title: Padding(
          ...
          child: Row(
            ...
            children: [
            IconButton(icon: FaIcon(FontAwesomeIcons.steam),disabledColor: Color(0xFFFE3C72),iconSize: 24, onPressed: null),
            IconButton(icon: FaIcon(FontAwesomeIcons.comments), onPressed: null),
            IconButton(icon: FaIcon(FontAwesomeIcons.userCircle), onPressed: null),
            ],
          ),
        ),
      ),
