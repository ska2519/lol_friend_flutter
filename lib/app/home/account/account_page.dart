...
class AccountPage extends StatefulWidget {
  const AccountPage(
      {Key key, this.apiService, this.user, this.database, this.userProfile})
      : super(key: key);
...
class _AccountPageState extends State<AccountPage> {
  ...
  Future<void> _submit() async {
    ...
    _summonerLeague =
        await dataRepository.getSummonerLeagueDataByName(_summoner.summonerId);
  ...
  Widget build(BuildContext context) {
    ...
    return MultiProvider(
      providers: [
        Provider<Summoner>(create: (_) => Summoner()),
        Provider<SummonerLeague>(create: (_) => SummonerLeague()),
      ],
            ...
            TextFormField(
              ...
              decoration: InputDecoration(
                ...
                focusedBorder: OutlineInputBorder(
                    borderRadius: BorderRadius.all(Radius.circular(12.0)),
                    borderSide:
                        BorderSide(color: Color(0xFF0091EA), width: 1.0)),
              ),
            ),
            SizedBox(height: 30.0),
            Container(
